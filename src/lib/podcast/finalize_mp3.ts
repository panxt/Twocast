...
export function embedScript(mp3: Buffer, lines: TimedScriptItem[], durationSeconds: number, title = '驿·声笺'): Buffer {
  ...
  const frames = Buffer.concat([
    ...
    id3Frame('TPE1', id3Text('驿·声笺')),
    id3Frame('TALB', id3Text('驿·声笺')),
